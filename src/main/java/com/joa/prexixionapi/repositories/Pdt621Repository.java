...
public class Pdt621Repository {
        ...
        for (Tuple rs : results) {
            Pdt621ReportAnualDTO dto = Pdt621ReportAnualDTO.builder()
                    ...
                    .registros(rs.get("feDeclaracion") != null ? List.of(Pdt621RegistroDTO.builder()
                            ...
                            .nroRectificacion(String.valueOf(
                                    rs.get("numeroRectificatorias") == null ? "" : rs.get("numeroRectificatorias")))
    ...
    public List<Pdt621ReportAnualDTO> listAnualPorAnio(String ruc, String anio) {
        String query = """
                ...
                p.mesPer, p.mesAnteriorPer, p.compensacionPer, p.ajustePer, p.resultadoPer, p.codigosTributariosCompensacionPer,
                p.mesRet, p.mesAnteriorRet, p.compensacionRet, p.ajusteRet, p.resultadoRet, p.codigosTributariosCompensacionRet, p.igvPorPagar,
        ...
        for (Tuple rs : results) {
            Pdt621ReportAnualDTO dto = Pdt621ReportAnualDTO.builder()
                    ...
                    .codigosTributariosCompensacionPer(rs.get("codigosTributariosCompensacionPer", String.class))
                    ...
                    .codigosTributariosCompensacionRet(rs.get("codigosTributariosCompensacionRet", String.class))
                    .igvPorPagar(toDouble(rs.get("igvPorPagar")))
                    .ivapVentasGravadas(toDouble(rs.get("ivapVentasGravadas")))
                    .ivapTributo(toDouble(rs.get("ivapTributo")))
