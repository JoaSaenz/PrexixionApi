...
@Embeddable
public class LoginCompraId implements Serializable {
    ...
    public LoginCompraId() {}

    public LoginCompraId(String idCliente, String anio, String mes) {
    ...
    public boolean equals(Object o) {
        ...
        LoginCompraId that = (LoginCompraId) o;
